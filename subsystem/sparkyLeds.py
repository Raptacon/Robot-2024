...
class Leds(commands2.Subsystem):
    ...
    def __init__(self):
        ...
        self.strips["frontRight"]= Strip(self.ledData[0:9])
        #Right Read- 2nd 9 in reverse order
        self.strips["rearRight"]= Strip(self.ledData[9:18][::-1])
        #Left 3rd set of 9 in order
        self.strips["rearLeft"] =  Strip(self.ledData[18:27])
        #Left 4th set of 9 reverse order
        self.strips["frontLeft"] =  Strip(self.ledData[27:36][::-1])
